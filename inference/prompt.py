...
{"type": "function", "function": {"name": "connector_search", "description": "Search through external connectors like GitHub, Drive, etc.", "parameters": {"type": "object", "properties": {"query": {"type": "string", "description": "The search query."}, "connector_id": {"type": "string", "description": "The connector ID to search (e.g., 'github'). Default is 'github'.", "default": "github"}}, "required": ["query"]}}}
{"type": "function", "function": {"name": "internal_retrieval", "description": "Retrieves knowledge from internal knowledge base.", "parameters": {"type": "object", "properties": {"query": {"type": "string", "description": "The query to search for in the internal knowledge base."}}, "required": ["query"]}}}
</tools>
